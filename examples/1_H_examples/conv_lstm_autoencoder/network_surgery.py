...
caffe.set_mode_cpu()
# caffe.set_mode_gpu()
model_def = caffe_root + 'examples/1_H_examples/conv_lstm_autoencoder/mnist_lstm_relu_AE2_test2.prototxt'
# model_weights = caffe_root + 'examples/1_H_examples/conv_lstm_autoencoder/conv_lstm_relu_AE_iter_20000.caffemodel' # ERROR > 50
model_weights = caffe_root + 'examples/1_H_examples/conv_lstm_autoencoder/conv_lstm_relu_AE_iter_1440.caffemodel' #ERROR = 0.1088
# Load model
...
# weight =net.params['encode1'][0].data
# b = net.params['encode1'][1].data
# c = net.params['encode1'][2].data
