#ifndef CAFFE_LSTM_RELU_LAYER_HPP_
#define CAFFE_LSTM_RELU_LAYER_HPP_
...
class LSTMReLULayer : public RecurrentLayer<Dtype> {
 public:
  explicit LSTMReLULayer(const LayerParameter& param)
      : RecurrentLayer<Dtype>(param) {}

  virtual inline const char* type() const { return "LSTMReLU"; }
 ...
 */
template <typename Dtype>
class LSTMReLUUnitLayer : public Layer<Dtype> {
 public:
  explicit LSTMReLUUnitLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);

  virtual inline const char* type() const { return "LSTMReLUUnit"; }
