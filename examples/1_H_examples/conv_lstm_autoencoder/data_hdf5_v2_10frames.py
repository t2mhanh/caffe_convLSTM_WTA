...
#print a.shape
h5f = h5py.File('/usr/not-backed-up/1_convlstm/bouncing_mnist_train_AE.h5','w')
...
# h5f.close()
h5f = h5py.File('/usr/not-backed-up/1_convlstm/bouncing_mnist_test_AE.h5','w')
h5f.create_dataset('input',shape = b[8000:10000,0:10,:,:].shape, dtype=b.dtype)
h5f.create_dataset('match',shape = b[8000:10000,0:10,:,:].shape, dtype=b.dtype)
h5f['input'][:] = b[8000:10000,0:10,:,:]
h5f['match'][:] = b[8000:10000,0:10,:,:]
